  ...
  return (
    <main className="relative flex h-screen w-full flex-col items-center bg-gray-950 antialiased bg-grid-white/[0.02] overflow-y-auto overflow-x-hidden">
      ...
      <section className="relative z-10 w-full">
        <div className="mx-auto mt-12 max-w-5xl rounded-2xl border border-white/10 bg-neutral-900/70 px-6 py-10 backdrop-blur-md">
          <h2 className="text-2xl font-semibold text-white md:text-3xl">
            Open-source online motion graphics editor
          </h2>
          <p className="mt-4 max-w-3xl text-neutral-300">
            MotionShapes is built for fast browser-based animation workflows: logo
            animation, product showcase videos, social clips, and 2D motion design.
          </p>
          <p className="mt-2 max-w-3xl text-neutral-300">
            Use visual timeline controls, reusable templates, and export-ready output
            to ship polished motion content quickly.
          </p>
          <div className="mt-5 flex flex-wrap gap-2 text-xs text-neutral-300">
            <span className="rounded-full border border-white/20 px-3 py-1">logo animation maker</span>
            <span className="rounded-full border border-white/20 px-3 py-1">product demo video creator</span>
            <span className="rounded-full border border-white/20 px-3 py-1">social media animation tool</span>
            <span className="rounded-full border border-white/20 px-3 py-1">2D motion graphics editor</span>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-4xl px-4">
          <div className="flex flex-col items-center gap-8 md:flex-row md:justify-between md:items-start">
            ...
            <div className="text-center md:text-left">
              ...
              <nav className="mt-4 flex flex-wrap items-center justify-center gap-3 text-sm md:justify-start">
                <Link href="/features" className="text-neutral-300 transition hover:text-white">
                  Features
                </Link>
                <Link href="/use-cases" className="text-neutral-300 transition hover:text-white">
                  Use Cases
                </Link>
                <Link href="/about" className="text-neutral-300 transition hover:text-white">
                  About
                </Link>
                <Link href="/contribute" className="text-neutral-300 transition hover:text-white">
                  Contribute
                </Link>
                <Link href="/llms.txt" className="text-neutral-300 transition hover:text-white">
                  AI Crawl Policy
                </Link>
              </nav>
            </div>
